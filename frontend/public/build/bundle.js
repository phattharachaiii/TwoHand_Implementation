...
var app = (function () {
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(p, file$1, 104, 4, 2300);
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	let t7;
    	let button;
    	let t8_value = (/*isLoading*/ ctx[6] ? "Registering..." : "Register") + "";
    	let t8;
    	let t9;
    	let mounted;
    	let dispose;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$1, 71, 2, 1612);
    			attr_dev(input0, "type", "text");
    			attr_dev(input0, "placeholder", "Username");
    			input0.required = true;
    			attr_dev(input0, "class", "svelte-9iq5uj");
    			add_location(input0, file$1, 72, 2, 1633);
    			attr_dev(input1, "type", "email");
    			attr_dev(input1, "placeholder", "Email");
    			input1.required = true;
    			attr_dev(input1, "class", "svelte-9iq5uj");
    			add_location(input1, file$1, 78, 2, 1735);
    			attr_dev(input2, "type", "password");
    			attr_dev(input2, "placeholder", "Password");
    			input2.required = true;
    			attr_dev(input2, "class", "svelte-9iq5uj");
    			add_location(input2, file$1, 84, 2, 1832);
    			attr_dev(input3, "type", "password");
    			attr_dev(input3, "placeholder", "Confirm Password");
    			input3.required = true;
    			attr_dev(input3, "class", "svelte-9iq5uj");
    			add_location(input3, file$1, 90, 2, 1938);
    			attr_dev(input4, "type", "checkbox");
    			attr_dev(input4, "class", "svelte-9iq5uj");
    			add_location(input4, file$1, 97, 4, 2072);
    			attr_dev(label, "class", "svelte-9iq5uj");
    			add_location(label, file$1, 96, 2, 2059);
    			button.disabled = /*isLoading*/ ctx[6];
    			attr_dev(button, "class", "svelte-9iq5uj");
    			add_location(button, file$1, 100, 2, 2162);
    			attr_dev(div, "class", "form svelte-9iq5uj");
    			add_location(div, file$1, 70, 0, 1590);
    		},
    		...
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*registerUser*/ ctx[7], false, false, false, false)
    				];
    		...
    		p: function update(ctx, [dirty]) {
    			...
    			if (dirty & /*isSeller*/ 16) {
    				input4.checked = /*isSeller*/ ctx[4];
    			}

    			if (dirty & /*isLoading*/ 64 && t8_value !== (t8_value = (/*isLoading*/ ctx[6] ? "Registering..." : "Register") + "")) set_data_dev(t8, t8_value);

    			if (dirty & /*isLoading*/ 64) {
    				prop_dev(button, "disabled", /*isLoading*/ ctx[6]);
    			}
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	const registerUser = async () => {
    		...
    		try {
    			...
    			if (response.ok) {
    				$$invalidate(5, message = `User registered successfully!`);
    			} else {
    				$$invalidate(5, message = `Error: ${result.message || result.error}`);
    			}
    		} catch(err) {
    			$$invalidate(5, message = `Error: ${err.message}`);
    		} finally {
    	...
    	function input4_change_handler() {
    		isSeller = this.checked;
    		$$invalidate(4, isSeller);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('isSeller' in $$props) $$invalidate(4, isSeller = $$props.isSeller);
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		...
    		m: function mount(target, anchor) {
    			...
    			mount_component(register, main, null);
    			current = true;
    		},
    		p: noop,
